...
#			sudo mkdir -p /home/hyerkim/data/vol_mysql
#			sudo chown -R mysql:mysql /home/hyerkim/data/vol_mysql

#			sudo userdel www-data
#			sudo useradd -u 999 www-data
			sudo mkdir -p /home/hyerkim/data/vol_wp /home/hyerkim/data/vol_mysql
